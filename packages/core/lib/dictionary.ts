...
export const defaultDictionary = {
  ...
  "field-stringlist-moveup": "Move up",
  "field-stringlist-movedown": "Move down",
  "field-stringlist-invalid":
    "The value does not match this list field. No change was applied.",
